  ...
  <div class="home-page">
    ...
    <main class="main-content">
      ...
      <div class="content-area">
        ...
        <!-- 热门推荐（与下方榜单区分离，不参与列表滚动） -->
        <section class="section home-hot-section">
          <div class="section-header">
            <h2>热门推荐</h2>
        ...
        <div class="home-content-divider" aria-hidden="true" />

        <!-- 榜单 Tab：位于「热门推荐」与分割线之下，仅下方歌曲列表滚动 -->
        ...
        <div class="home-tab-panel">
          <!-- 排行榜 -->
          <section class="section ranking-section home-tab-section" v-if="activeListTab === 'ranking'">
            <div class="section-header">
              <h2>排行榜</h2>
            </div>
            <div class="home-song-list-scroll">
          ...
          <!-- 最新音乐 / 最多收藏 / 最多评论 -->
          <section class="section home-tab-section" v-if="['new', 'liked', 'comments'].includes(activeListTab)">
            <div class="section-header">
              <h2>{{ listTabTitle }}</h2>
            </div>
            <div class="home-song-list-scroll">
            ...
            <div class="pagination-wrapper home-tab-pagination" v-if="currentListTotal > 0">
            <el-pagination
              background
...
import { trackApi, playlistApi, favoriteApi, userApi, announcementApi, notificationApi, type NotificationItem } from '../api'
...
const currentCommentTrack = ref<{ id: number; title?: string } | null>(null)
...
const openCommentDrawer = (track: any) => {
  currentCommentTrack.value = track
  showCommentDrawer.value = true
}
...
.home-tab-section .section-header {
  flex-shrink: 0;
  margin-bottom: var(--sp-3);
}
